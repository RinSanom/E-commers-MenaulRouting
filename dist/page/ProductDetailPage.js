...
export function ProductDetail(id) {
            ...
            <div class="flex justify-between items-start">
              <div>
                ...
                <div class="flex items-center mt-2">
                  ...
                  <span class="text-gray-500 ml-2">(${((_a = product.reviews) === null || _a === void 0 ? void 0 : _a.length) || 0} reviews)</span>
                </div>
              </div>
              <span class="bg-rose-100 text-rose-800 text-sm font-semibold px-3 py-1 rounded-full">${product.discountPercentage.toFixed(0)}% OFF</span>
            </div>
  ...
  <section class="py-12 bg-white">
    <div class="container mx-auto px-4">
      ...
      ${((_b = product.reviews) === null || _b === void 0 ? void 0 : _b.length) > 0 ? `
